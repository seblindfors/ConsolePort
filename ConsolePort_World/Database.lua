...
---------------------------------------------------------------
	...
	QMenuNumBuffs = _{Data.Range(10, 1, 1, 20);
		name = 'Buff Slots';
		desc = 'Number of buff slots shown in the quick menu.';
		list = SETTING_GROUP_GAMEPLAY;
		deps = { QMenuCollectionBuffs = true };
		hide = not CPAPI.IsRetailVersion;
	};
	QMenuNumDebuffs = _{Data.Range(10, 1, 1, 10);
		name = 'Debuff Slots';
		desc = 'Number of debuff slots shown in the quick menu.';
		list = SETTING_GROUP_GAMEPLAY;
		deps = { QMenuCollectionDebuffs = true };
		hide = not CPAPI.IsRetailVersion;
	};

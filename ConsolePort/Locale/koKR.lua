local L = select(2, ...).Locale:GetLocale('koKR'); if not L then return end;
---------------------------------------------------------------
-- koKR 한국어 Korean
---------------------------------------------------------------
---------------------------------------------------------------
...
L['Match criteria for unit pool, each type separated by semicolon.'] = '유닛 풀의 일치 기준, 각 유형은 세미콜론으로 구분.';
L['Max Pitch'] = '최대 피치';

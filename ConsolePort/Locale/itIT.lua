...
L['Friendly Players Only'] = 'Solo giocatori amichevoli';
...
L['Only open the unit menu when interacting with friendly players.'] = 'Apri il menu unità solo quando interagisci con giocatori amichevoli.';

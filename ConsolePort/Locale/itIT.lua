local L = select(2, ...).Locale:GetLocale('itIT'); if not L then return end;
---------------------------------------------------------------
...
L['Match criteria for unit pool, each type separated by semicolon.'] = 'Criteri di corrispondenza per il pool di unità, ogni tipo separato da punto e virgola.';

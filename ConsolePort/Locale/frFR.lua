...
L.DESC_RING_TARGET            = "Affiche votre pool d'unités dans un menu radial, vous permettant de cibler une unité avec le stick radial."; -- en:294b636e
...
L.NAME_RING_TARGET            = 'Menu radial de cible (maintenir)'; -- en:59e8a9cb
...
-- Literals
---------------------------------------------------------------
L['%s will be disabled the next time the interface is reloaded.'] = '%s sera désactivé au prochain rechargement de l\'interface.';
...
L['Activate targeting components only while their bindings are in use.'] = 'Active les composants de ciblage uniquement lorsque leurs raccourcis sont utilisés.';
...
L['Allow casting on mouseover targets, when enabled in the game options.'] = "Permet de lancer des sorts sur la cible survolée, si l'option est activée dans les options du jeu.";
...
L['Assist Mode'] = "Mode d'assistance";
...
L['Automatically disabled if an inactive component is clicked from a macro.'] = 'Désactivé automatiquement si un composant inactif est cliqué depuis une macro.';
...
L['Casting this spell without an assistable target opens the ring to pick the target.'] = 'Lancer ce sort sans cible assistable ouvre le menu radial pour choisir la cible.';
...
L['Class Colored Health'] = 'Santé aux couleurs de classe';
...
L['Color the health bars in the target ring by class.'] = 'Colore les barres de santé du menu radial de cible selon la classe.';
...
L['Emulate Pad 5'] = 'Émuler Pad 5';
L['Emulate Pad 6'] = 'Émuler Pad 6';
L['Emulate Pad Back'] = 'Émuler Retour';
L['Emulate Pad Forward'] = 'Émuler Avancer';
L['Emulate Pad Social'] = 'Émuler Social';
L['Emulate Pad System'] = 'Émuler Système';
...
L['Enable Lazy Loading'] = 'Activer le chargement différé';
...
L['Friendly Players Only'] = 'Joueurs amicaux uniquement';
...
L['Key %d'] = 'Touche %d';
L['Keyboard button to emulate the back button.'] = 'Touche clavier pour émuler le bouton retour.';
L['Keyboard button to emulate the forward button.'] = 'Touche clavier pour émuler le bouton avancer.';
L['Keyboard button to emulate the pad 5 button.'] = 'Touche clavier pour émuler le bouton pad 5.';
L['Keyboard button to emulate the pad 6 button.'] = 'Touche clavier pour émuler le bouton pad 6.';
L['Keyboard button to emulate the social button.'] = 'Touche clavier pour émuler le bouton social.';
L['Keyboard button to emulate the system button.'] = 'Touche clavier pour émuler le bouton système.';
L['Keyboard'] = 'Clavier';
...
L['Lazy loading has been disabled to activate the raid cursor.'] = 'Le chargement différé a été désactivé pour activer le curseur de raid.';
L['Lazy loading has been disabled to activate the target ring.'] = 'Le chargement différé a été désactivé pour activer le menu radial de cible.';
L['Lazy loading has been disabled to activate unit hotkeys.'] = "Le chargement différé a été désactivé pour activer les raccourcis d'unité.";
...
L['Modules'] = 'Modules';
L['Mouseover Cast'] = 'Incantation au survol';
L['Move Left'] = 'Déplacer à gauche';
L['Move one of the sticks.'] = 'Bouge un des sticks.';
L['Move Right'] = 'Déplacer à droite';
L['Move the frame with the sticks or the mouse. Confirm to save, cancel to restore.'] = 'Déplacez le cadre avec les sticks ou la souris. Confirmez pour enregistrer, annulez pour restaurer.';
...
L['Navigate the interface with the gamepad using a virtual cursor.'] = 'Naviguez dans l\'interface avec la manette à l\'aide d\'un curseur virtuel.';
...
L['Only open the unit menu when interacting with friendly players.'] = 'N\'ouvrir le menu d\'unité que lors d\'une interaction avec des joueurs amicaux.';
...
L['Pet Ring Position'] = 'Position du menu radial de familier';
L['Pet Ring Stick'] = 'Stick du menu radial de familier';
L['Pick up'] = 'Ramasser';
L['Pickup'] = 'Ramassage';
...
L['Radial on-screen keyboard for typing with the gamepad.'] = 'Clavier radial à l\'écran pour écrire avec la manette.';
...
L['Replaces the default action bars with a layout designed for gamepad play.'] = 'Remplace les barres d\'actions par défaut par une disposition conçue pour la manette.';
...
L['Replaces the game menu with a controller-friendly menu and a quick access ring.'] = 'Remplace le menu du jeu par un menu adapté à la manette et un anneau d\'accès rapide.';
...
L['Requires the mouseover cast option in the game combat settings.'] = "Nécessite l'option d'incantation au survol dans les paramètres de combat du jeu.";
...
L['Screen position of the ring.'] = "Position du menu radial à l'écran.";
...
L['Stick to use for the pet ring. Default follows the radial menu primary stick.'] = 'Stick à utiliser pour le menu radial de familier. Par défaut, suit le stick principal des menus radiaux.';
L['Stick to use for this ring. Default follows the radial menu primary stick.'] = 'Stick à utiliser pour ce menu radial. Par défaut, suit le stick principal des menus radiaux.';
...
L['Switch the action bar layout to %s? Your current layout will be replaced.'] = 'Passer la disposition de la barre d\'actions à %s ? Votre disposition actuelle sera remplacée.';
...
L['Target Ring'] = 'Menu radial de cible';
L['Targeting Mode'] = 'Mode de ciblage';
L['Targeting tools: raid cursor, unit hotkeys and the target ring.'] = 'Outils de ciblage : curseur de raid, raccourcis d\'unités et anneau de cible.';
...
L['Units to watch, as lists of unit tokens selected by macro conditions. Use [] for the unconditional fallback.'] = 'Unités à surveiller, en listes de tokens choisies par conditions de macro. Utilisez [] comme repli inconditionnel.';
...
L['Utility rings for spells, items and macros, selected with the radial stick.'] = 'Anneaux utilitaires pour les sorts, objets et macros, sélectionnés avec le stick radial.';
...
L['World'] = 'Monde';
L['World interaction helpers: quick menu, loot frame and temporary ability prompts.'] = 'Aides à l\'interaction avec le monde : menu rapide, fenêtre de butin et invites de capacités temporaires.';

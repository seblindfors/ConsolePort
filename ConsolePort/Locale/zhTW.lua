...
-- Literals
---------------------------------------------------------------
L['%s will be disabled the next time the interface is reloaded.'] = '%s將在下次重新載入介面時停用。';
...
L['Allow casting on mouseover targets, when enabled in the game options.'] = '在遊戲選項中啟用後，可對滑鼠懸停目標施法。';
...
L['Casting Bar'] = '施法栏';
L['Casting this spell without an assistable target opens the ring to pick the target.'] = '在沒有可協助目標時施放此法術，將打開目標環以選擇目標。';
L['Center Gap'] = '中心間隙';
...
L['Friendly Players Only'] = '僅限友方玩家';
...
L['Navigate the interface with the gamepad using a virtual cursor.'] = '使用虛擬游標透過手把操作介面。';
...
L['Only open the unit menu when interacting with friendly players.'] = '僅在與友方玩家互動時開啟單位選單。';
...
L['Quick Menu'] = '快捷菜單';
L['Radial Menus'] = '徑向菜單';
L['Radial on-screen keyboard for typing with the gamepad.'] = '用於手把輸入的徑向螢幕鍵盤。';
L['Raid Cursor'] = '團隊光標';
...
L['Replaces the default action bars with a layout designed for gamepad play.'] = '以專為手把設計的配置取代預設快捷列。';
L['Replaces the default loot frame with a custom version optimized for controller navigation.'] = '用针對控製器导航優化的自定義版本替換默認拾取框架。';
L['Replaces the game menu with a controller-friendly menu and a quick access ring.'] = '以適合手把的選單和快速存取環取代遊戲選單。';
...
L['Requires the mouseover cast option in the game combat settings.'] = '需要在遊戲戰鬥設定中啟用滑鼠懸停施法。';
...
L['Switch the action bar layout to %s? Your current layout will be replaced.'] = '將快捷列配置切換為%s？目前的配置將被取代。';
...
L['Targeting tools: raid cursor, unit hotkeys and the target ring.'] = '目標工具：團隊游標、單位快捷鍵和目標環。';
L['Test Device'] = '测試設備';
...
L['Utility rings for spells, items and macros, selected with the radial stick.'] = '用於法術、物品和巨集的實用環，透過徑向搖桿選擇。';
...
L['World'] = '世界';
L['World interaction helpers: quick menu, loot frame and temporary ability prompts.'] = '世界互動輔助：快捷選單、拾取視窗和臨時技能提示。';
L['X Offset'] = 'X 偏移';

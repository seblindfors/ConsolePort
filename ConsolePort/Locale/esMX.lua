...
L['Match criteria for unit pool, each type separated by semicolon.'] = 'Criterios de coincidencia para el grupo de unidades, cada tipo separado por punto y coma.';
...
[condición] Nombre del preajuste; nil

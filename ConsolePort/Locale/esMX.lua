...
-- Literals
---------------------------------------------------------------
L['%s will be disabled the next time the interface is reloaded.'] = '%s se desactivará la próxima vez que se recargue la interfaz.';
...
L['Allow casting on mouseover targets, when enabled in the game options.'] = 'Permite lanzar hechizos al objetivo bajo el cursor, si está activado en las opciones del juego.';
...
L['Assist Mode'] = 'Modo de asistencia';
...
L['Casting this spell without an assistable target opens the ring to pick the target.'] = 'Lanzar este hechizo sin un objetivo asistible abre el menú radial para elegir el objetivo.';
...
L['Friendly Players Only'] = 'Solo jugadores amistosos';
...
L['Modules'] = 'Módulos';
L['Mouseover Cast'] = 'Lanzamiento al apuntar';
L['Move Left'] = 'Mover a la izquierda';
L['Move one of the sticks.'] = 'Mueve uno de los sticks.';
L['Move Right'] = 'Mover a la derecha';
L['Move the frame with the sticks or the mouse. Confirm to save, cancel to restore.'] = 'Mueve el marco con los sticks o el ratón. Confirma para guardar, cancela para restaurar.';
...
L['Navigate the interface with the gamepad using a virtual cursor.'] = 'Navega por la interfaz con el mando mediante un cursor virtual.';
...
L['Only open the unit menu when interacting with friendly players.'] = 'Abrir el menú de unidad solo al interactuar con jugadores amistosos.';
...
L['Pet Ring Position'] = 'Posición del menú radial de mascota';
...
L['Radial on-screen keyboard for typing with the gamepad.'] = 'Teclado radial en pantalla para escribir con el mando.';
...
L['Replaces the default action bars with a layout designed for gamepad play.'] = 'Sustituye las barras de acción predeterminadas por un diseño pensado para jugar con mando.';
...
L['Replaces the game menu with a controller-friendly menu and a quick access ring.'] = 'Sustituye el menú del juego por un menú adaptado al mando y un anillo de acceso rápido.';
...
L['Requires the mouseover cast option in the game combat settings.'] = 'Requiere la opción de lanzamiento al apuntar en los ajustes de combate del juego.';
...
L['Screen position of the ring.'] = 'Posición del menú radial en pantalla.';
...
L['Switch the action bar layout to %s? Your current layout will be replaced.'] = '¿Cambiar el diseño de la barra de acción a %s? Tu diseño actual será reemplazado.';
...
L['Targeting tools: raid cursor, unit hotkeys and the target ring.'] = 'Herramientas de selección: cursor de banda, teclas rápidas de unidad y el anillo de objetivos.';
...
L['Utility rings for spells, items and macros, selected with the radial stick.'] = 'Anillos de utilidad para hechizos, objetos y macros, seleccionados con el stick radial.';
...
L['World'] = 'Mundo';
L['World interaction helpers: quick menu, loot frame and temporary ability prompts.'] = 'Ayudas para interactuar con el mundo: menú rápido, ventana de botín y avisos de habilidades temporales.';

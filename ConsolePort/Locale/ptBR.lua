...
L.DESC_RING_TARGET            = 'Exibe seu pool de unidades em um menu radial, permitindo mirar uma unidade com o stick radial.'; -- en:294b636e
...
L.NAME_RING_TARGET            = 'Menu radial de alvo (segurar)'; -- en:59e8a9cb
...
-- Literals
---------------------------------------------------------------
L['%s will be disabled the next time the interface is reloaded.'] = '%s será desativado na próxima vez que a interface for recarregada.';
...
L['Activate targeting components only while their bindings are in use.'] = 'Ativa os componentes de seleção de alvo apenas enquanto suas ligações estão em uso.';
...
L['Allow casting on mouseover targets, when enabled in the game options.'] = 'Permite lançar feitiços no alvo sob o cursor, quando ativado nas opções do jogo.';
...
L['Assist Mode'] = 'Modo de assistência';
...
L['Automatically disabled if an inactive component is clicked from a macro.'] = 'Desativado automaticamente se um componente inativo for clicado por uma macro.';
...
L['Casting this spell without an assistable target opens the ring to pick the target.'] = 'Lançar este feitiço sem um alvo assistível abre o menu radial para escolher o alvo.';
...
L['Class Colored Health'] = 'Vida com cor de classe';
...
L['Color the health bars in the target ring by class.'] = 'Colore as barras de vida do menu radial de alvo por classe.';
...
L['Emulate Pad Back'] = 'Emular Voltar';
L['Emulate Pad Forward'] = 'Emular Avançar';
...
L['Enable Lazy Loading'] = 'Ativar carregamento sob demanda';
...
L['Friendly Players Only'] = 'Apenas jogadores amigáveis';
...
L['Key %d'] = 'Tecla %d';
L['Keyboard button to emulate the back button.'] = 'Tecla de teclado para emular o botão voltar.';
L['Keyboard button to emulate the forward button.'] = 'Tecla de teclado para emular o botão avançar.';
L['Keyboard button to emulate the pad 5 button.'] = 'Tecla de teclado para emular o botão pad 5.';
L['Keyboard button to emulate the pad 6 button.'] = 'Tecla de teclado para emular o botão pad 6.';
L['Keyboard button to emulate the social button.'] = 'Tecla de teclado para emular o botão social.';
L['Keyboard button to emulate the system button.'] = 'Tecla de teclado para emular o botão de sistema.';
L['Keyboard'] = 'Teclado';
...
L['Layout'] = 'Layout';
L['Lazy loading has been disabled to activate the raid cursor.'] = 'O carregamento sob demanda foi desativado para ativar o cursor de raide.';
L['Lazy loading has been disabled to activate the target ring.'] = 'O carregamento sob demanda foi desativado para ativar o menu radial de alvo.';
L['Lazy loading has been disabled to activate unit hotkeys.'] = 'O carregamento sob demanda foi desativado para ativar as teclas rápidas de unidade.';
L['LED Color Type'] = 'Tipo de cor LED';
L['LED Custom Color'] = 'Cor LED personalizada';
L['Load'] = 'Carregar';
L['Loaded binding preset %s.'] = 'Predefinição de ligação %s carregada.';
L['Loadout'] = 'Loadout';
...
L['Modules'] = 'Módulos';
L['Mouseover Cast'] = 'Lançamento por mouseover';
L['Move Left'] = 'Mover para a esquerda';
L['Move one of the sticks.'] = 'Mova um dos sticks.';
L['Move Right'] = 'Mover para a direita';
L['Move the frame with the sticks or the mouse. Confirm to save, cancel to restore.'] = 'Mova o quadro com os sticks ou o mouse. Confirme para salvar, cancele para restaurar.';
...
L['Navigate the interface with the gamepad using a virtual cursor.'] = 'Navegue pela interface com o controle usando um cursor virtual.';
...
L['No binding preset named %s exists.'] = 'Não existe nenhuma predefinição de ligação chamada %s.';
...
L['Only open the unit menu when interacting with friendly players.'] = 'Abrir o menu de unidade apenas ao interagir com jogadores amigáveis.';
...
L['Pet Ring Position'] = 'Posição do menu radial de mascote';
L['Pet Ring Stick'] = 'Stick do menu radial de mascote';
L['Pick up'] = 'Pegar';
L['Pickup'] = 'Coleta';
...
L['Radial on-screen keyboard for typing with the gamepad.'] = 'Teclado radial na tela para digitar com o controle.';
...
L['Replaces the default action bars with a layout designed for gamepad play.'] = 'Substitui as barras de ação padrão por um layout projetado para jogar com controle.';
...
L['Replaces the game menu with a controller-friendly menu and a quick access ring.'] = 'Substitui o menu do jogo por um menu adaptado ao controle e um anel de acesso rápido.';
...
L['Requires the mouseover cast option in the game combat settings.'] = 'Requer a opção de lançamento por mouseover nas configurações de combate do jogo.';
...
L['Screen position of the ring.'] = 'Posição do menu radial na tela.';
...
L['Stick to use for the pet ring. Default follows the radial menu primary stick.'] = 'Stick a usar para o menu radial de mascote. O padrão segue o stick principal dos menus radiais.';
L['Stick to use for this ring. Default follows the radial menu primary stick.'] = 'Stick a usar para este menu radial. O padrão segue o stick principal dos menus radiais.';
...
L['Switch the action bar layout to %s? Your current layout will be replaced.'] = 'Mudar o layout da barra de ação para %s? Seu layout atual será substituído.';
...
|cFF3FC7EB[condição] Nome da predefinição; nil|r
...
L['Target Ring'] = 'Menu radial de alvo';
L['Targeting Mode'] = 'Modo de mira';
L['Targeting tools: raid cursor, unit hotkeys and the target ring.'] = 'Ferramentas de seleção de alvo: cursor de raide, teclas de atalho de unidade e o anel de alvos.';
...
L['Units to watch, as lists of unit tokens selected by macro conditions. Use [] for the unconditional fallback.'] = 'Unidades a observar, como listas de tokens selecionadas por condições de macro. Use [] como alternativa incondicional.';
...
L['Utility rings for spells, items and macros, selected with the radial stick.'] = 'Anéis utilitários para feitiços, itens e macros, selecionados com o direcional radial.';
...
L['World'] = 'Mundo';
L['World interaction helpers: quick menu, loot frame and temporary ability prompts.'] = 'Auxílios para interação com o mundo: menu rápido, janela de saque e avisos de habilidades temporárias.';

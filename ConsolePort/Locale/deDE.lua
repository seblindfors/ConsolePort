...
L.DESC_RING_TARGET            = 'Zeigt deinen Einheiten-Pool in einem Ring an, sodass du eine Einheit mit dem radialen Stick anvisieren kannst.'; -- en:294b636e
...
L.NAME_RING_TARGET            = 'Ziel-Ring (Halten)'; -- en:59e8a9cb
...
-- Literals
---------------------------------------------------------------
L['%s will be disabled the next time the interface is reloaded.'] = '%s wird beim nächsten Neuladen der Benutzeroberfläche deaktiviert.';
...
L['Allow casting on mouseover targets, when enabled in the game options.'] = 'Erlaubt Zauber auf Mouseover-Ziele, wenn in den Spieloptionen aktiviert.';
...
L['Assist Mode'] = 'Unterstützungsmodus';
...
L['Casting this spell without an assistable target opens the ring to pick the target.'] = 'Das Wirken dieses Zaubers ohne unterstützbares Ziel öffnet den Ring zur Zielauswahl.';
...
L['Class Colored Health'] = 'Klassenfarbene Gesundheit';
...
L['Color the health bars in the target ring by class.'] = 'Färbt die Gesundheitsbalken im Ziel-Ring nach Klasse.';
...
L['Friendly Players Only'] = 'Nur freundliche Spieler';
...
L['Lazy loading has been disabled to activate the target ring.'] = 'Verzögertes Laden wurde deaktiviert, um den Ziel-Ring zu aktivieren.';
...
L['Modules'] = 'Module';
L['Mouseover Cast'] = 'Mouseover-Zauber';
L['Move Left'] = 'Nach links bewegen';
L['Move one of the sticks.'] = 'Einen der Sticks bewegen.';
L['Move Right'] = 'Nach rechts bewegen';
L['Move the frame with the sticks or the mouse. Confirm to save, cancel to restore.'] = 'Bewege den Rahmen mit den Sticks oder der Maus. Bestätigen speichert, Abbrechen stellt wieder her.';
...
L['Navigate the interface with the gamepad using a virtual cursor.'] = 'Navigiere die Benutzeroberfläche mit dem Gamepad über einen virtuellen Cursor.';
...
L['Only open the unit menu when interacting with friendly players.'] = 'Öffnet das Einheitenmenü nur bei der Interaktion mit freundlichen Spielern.';
...
L['Pet Ring Position'] = 'Begleiter-Ring-Position';
L['Pet Ring Stick'] = 'Begleiter-Ring-Stick';
L['Pick up'] = 'Aufnehmen';
L['Pickup'] = 'Aufnahme';
...
L['Radial on-screen keyboard for typing with the gamepad.'] = 'Radiale Bildschirmtastatur zum Tippen mit dem Gamepad.';
...
L['Replaces the default action bars with a layout designed for gamepad play.'] = 'Ersetzt die Standard-Aktionsleisten durch ein für das Gamepad entworfenes Layout.';
...
L['Replaces the game menu with a controller-friendly menu and a quick access ring.'] = 'Ersetzt das Spielmenü durch ein controllerfreundliches Menü und einen Schnellzugriffsring.';
...
L['Requires the mouseover cast option in the game combat settings.'] = 'Erfordert die Mouseover-Zauber-Option in den Kampfeinstellungen des Spiels.';
...
L['Screen position of the ring.'] = 'Bildschirmposition des Rings.';
...
L['Stick to use for the pet ring. Default follows the radial menu primary stick.'] = 'Stick für den Begleiter-Ring. Standard folgt dem primären Stick der Ringmenüs.';
L['Stick to use for this ring. Default follows the radial menu primary stick.'] = 'Stick für diesen Ring. Standard folgt dem primären Stick der Ringmenüs.';
...
L['Switch the action bar layout to %s? Your current layout will be replaced.'] = 'Aktionsleisten-Layout zu %s wechseln? Dein aktuelles Layout wird ersetzt.';
...
L['Target Ring'] = 'Ziel-Ring';
L['Targeting Mode'] = 'Ziel-Modus';
L['Targeting tools: raid cursor, unit hotkeys and the target ring.'] = 'Zielwerkzeuge: Schlachtzugscursor, Einheiten-Hotkeys und der Zielring.';
...
L['Units to watch, as lists of unit tokens selected by macro conditions. Use [] for the unconditional fallback.'] = 'Zu beobachtende Einheiten als Token-Listen, ausgewählt über Makro-Bedingungen. [] ist der bedingungslose Fallback.';
...
L['Utility rings for spells, items and macros, selected with the radial stick.'] = 'Nützliche Ringe für Zauber, Gegenstände und Makros, ausgewählt mit dem radialen Stick.';
...
L['World'] = 'Welt';
L['World interaction helpers: quick menu, loot frame and temporary ability prompts.'] = 'Hilfen für die Interaktion mit der Welt: Schnellmenü, Beutefenster und Hinweise für temporäre Fähigkeiten.';
L['X Offset'] = 'X-Offset';

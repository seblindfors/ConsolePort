select(2, ...).Gamepad:AddGamepad({
	...
	Theme = {
		...
		Layout = { -- format: delta (-1 or 1), drawLayer, x1, y1, ..., xN, yN
			...
			--------------------
			PADPADDLE2   = {-1, -1, 90, -40, 160, -190};
			PADPADDLE4   = {-1,  1, 70, -60, 140, -230};
			--------------------
			PADSYSTEM    = {-1,  1, 0, -10, 40, -60, 120, -290};
			--------------------
			...
			--------------------
			PAD5         = {1,  1, 2, -40, 40, -100, 120, -290};
			--------------------
			PADPADDLE1   = {1, -1, 90, -40, 160, -190};
			PADPADDLE3   = {1,  1, 70, -60, 140, -230};
		};
	};
	Preset = {
		Variables = {

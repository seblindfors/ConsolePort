...
db:Register('Variables', CPAPI.Callable({
	...
	bindingPresetCondition = _{String(nil);
		name = 'Preset Load Condition';
		desc = 'Macro condition to automatically load a binding preset by name when the condition applies.';
		note = 'Takes the format of...\n'
			.. BLUE'[condition] Preset Name; nil'
			.. '\n\nThe preset is loaded when the condition applies, outside of combat. Character presets take precedence over device presets.';
		list = 'Presets';
		advd = true;
	};
	...
	emulatePAD5 = _{Pseudokey('none');
		name = 'Emulate '..(KEY_PAD5 or 'Pad 5');
		desc = 'Keyboard button to emulate the pad 5 button.';
		advd = true;
	};
	emulatePAD6 = _{Pseudokey('none');
		name = 'Emulate '..(KEY_PAD6 or 'Pad 6');
		desc = 'Keyboard button to emulate the pad 6 button.';
		advd = true;
	};
	emulatePADBACK = _{Pseudokey('none');
		name = 'Emulate '..(KEY_PADBACK or 'Pad Back');
		desc = 'Keyboard button to emulate the back button.';
		advd = true;
	};
	emulatePADFORWARD = _{Pseudokey('none');
		name = 'Emulate '..(KEY_PADFORWARD or 'Pad Forward');
		desc = 'Keyboard button to emulate the forward button.';
		advd = true;
	};
	emulatePADSYSTEM = _{Pseudokey('none');
		name = 'Emulate '..(KEY_PADSYSTEM or 'Pad System');
		desc = 'Keyboard button to emulate the system button.';
		advd = true;
	};
	emulatePADSOCIAL = _{Pseudokey('none');
		name = 'Emulate '..(KEY_PADSOCIAL or 'Pad Social');
		desc = 'Keyboard button to emulate the social button.';
		advd = true;
	};

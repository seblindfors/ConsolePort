...
db:Register('Variables', CPAPI.Callable({
	...
	unitHotkeyButton5 = _{Button('PADDDOWN', true):Set('none', true);
		name = 'Combo Button 5';
	...
	unitHotkeyButton6 = _{Button('PADDRIGHT', true):Set('none', true);
		name = 'Combo Button 6';
	...
	unitHotkeyButton7 = _{Button('PADDLEFT', true):Set('none', true);
		name = 'Combo Button 7';
	...
	unitHotkeyButton8 = _{Button('PADDUP', true):Set('none', true);
		name = 'Combo Button 8';
	...
	unitHotkeyColor1 = _{Color('ffffffff');
		name = 'Combo Color 1';
		desc = 'Color tint for combo hotkey 1.';
		list = CONTROLS_LABEL;
		advd = true;
	};
	unitHotkeyColor2 = _{Color('ffffffff');
		name = 'Combo Color 2';
		desc = 'Color tint for combo hotkey 2.';
		list = CONTROLS_LABEL;
		advd = true;
	};
	unitHotkeyColor3 = _{Color('ffffffff');
		name = 'Combo Color 3';
		desc = 'Color tint for combo hotkey 3.';
		list = CONTROLS_LABEL;
		advd = true;
	};
	unitHotkeyColor4 = _{Color('ffffffff');
		name = 'Combo Color 4';
		desc = 'Color tint for combo hotkey 4.';
		list = CONTROLS_LABEL;
		advd = true;
	};
	unitHotkeyColor5 = _{Color('ffffffff');
		name = 'Combo Color 5';
		desc = 'Color tint for combo hotkey 5.';
		list = CONTROLS_LABEL;
		advd = true;
	};
	unitHotkeyColor6 = _{Color('ffffffff');
		name = 'Combo Color 6';
		desc = 'Color tint for combo hotkey 6.';
		list = CONTROLS_LABEL;
		advd = true;
	};
	unitHotkeyColor7 = _{Color('ffffffff');
		name = 'Combo Color 7';
		desc = 'Color tint for combo hotkey 7.';
		list = CONTROLS_LABEL;
		advd = true;
	};
	unitHotkeyColor8 = _{Color('ffffffff');
		name = 'Combo Color 8';

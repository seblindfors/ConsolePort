---@deprecated The goal should be to remove this file entirely.
-- This file contains slightly customized versions of the Blizzard templates,
-- which are used in the ConsolePort configuration UI. The goal is to remove
-- this file entirely, and use the original Blizzard templates instead,
-- now that Classic has changed to the new config UI.
